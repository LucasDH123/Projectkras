<?php
    ...
    switch($domein){
        case 1;
            $domein = 'Domein registered';
            break;
        case 2;
            $domein = 'no valid domain' ;
            break;
        case 3;
            $domein = '';
            break;
...
<a id="first" href="../IndexEN.php">Back to home</a>
...
<form action="../PHP/check domain.php" method="post">
    <label for="domein">Enter a domain name here to register it</label><br>
